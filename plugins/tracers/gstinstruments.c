...
#define _do_init GST_DEBUG_CATEGORY_INIT (gst_instruments_debug, "instruments", 0, "instruments tracer");
...
static void
do_push_buffer_list_pre (G_GNUC_UNUSED GObject *self, G_GNUC_UNUSED GstClockTime ts, GstPad *sender_pad,
                         GstBufferList *list)
{
  if (GST_IS_GHOST_PAD (sender_pad))
    return;
...
static void
do_pull_range_pre (G_GNUC_UNUSED GObject *self, G_GNUC_UNUSED GstClockTime ts, GstPad *receiver_pad,
                   G_GNUC_UNUSED guint64 offset, G_GNUC_UNUSED guint size)
{
  optional_init ();
...
void
do_pull_range_post (G_GNUC_UNUSED GObject *self, G_GNUC_UNUSED GstClockTime ts, GstPad *receiver_pad, GstBuffer *buffer,
...
void
do_element_change_state_pre (G_GNUC_UNUSED GObject *self, G_GNUC_UNUSED GstClockTime ts,
                             G_GNUC_UNUSED GstElement *element, G_GNUC_UNUSED GstStateChange transition)
{
  optional_init ();
}

void
do_element_change_state_post (G_GNUC_UNUSED GObject *self, G_GNUC_UNUSED GstClockTime ts, GstElement *element,
                              GstStateChange transition, G_GNUC_UNUSED GstStateChangeReturn result)
{
  optional_init ();
  switch (transition) {
...
gst_instruments_tracer_init (GstInstrumentsTracer *self)
{
  ...
  gst_tracing_register_hook (tracer, "element-change-state-pre", G_CALLBACK (do_element_change_state_pre));
  gst_tracing_register_hook (tracer, "element-change-state-post", G_CALLBACK (do_element_change_state_post));
  ...
  gst_tracing_register_hook (tracer, "pad-push-post", G_CALLBACK (do_push_buffer_post));
  gst_tracing_register_hook (tracer, "pad-push-list-post", G_CALLBACK (do_push_buffer_list_post));
  gst_tracing_register_hook (tracer, "pad-pull-range-pre", G_CALLBACK (do_pull_range_pre));
  gst_tracing_register_hook (tracer, "pad-pull-range-post", G_CALLBACK (do_pull_range_post));
  gst_tracing_register_hook (tracer, "pad-push-event-pre", G_CALLBACK (do_push_event_pre));
}
...
GST_PLUGIN_DEFINE (GST_VERSION_MAJOR, GST_VERSION_MINOR, instruments, "gst-instruments tracer", plugin_init, VERSION,
                   "LGPL", "instruments", "GST_PACKAGE_ORIGIN")
